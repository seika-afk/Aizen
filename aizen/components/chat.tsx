...
const Chat: React.FC<ChatProps> = ({ onAiResponse }) => {
  ...
  return (
    <div className="relative w-full h-full flex flex-col text-[#e0ddcf] bg-[#313638] overflow-hidden">
      {/* Messages */}
      <div ref={containerRef} className="flex flex-col h-full overflow-y-auto px-2 py-4">
        {messages.length === 0 ? (
      ...
      <p className="text-xs text-white text-center pb-1">
        Contact{" "}
        <a href="mailto:talk2gagan09@gmail.com" className="underline hover:text-gray-700">
          Me
        </a>
        .
      </p>
